...
from BROKENXMUSIC.misc import SUDOERS, db
...
from BROKENXMUSIC.utils.inline import close_markup, stream_markup, stream_markup_timer
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Broken.pause_stream(chat_id)
        ...
        await Broken.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
